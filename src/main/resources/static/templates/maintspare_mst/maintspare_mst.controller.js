(function() {
    ...
    angular.module('myApp.maintspare_mst').controller('maintspare_mstController', maintspare_mstController);

    maintspare_mstController.$inject = ['$scope', 'ApiEndpoint', '$http', 'toastr','genericFactory'];

    function maintspare_mstController($scope, ApiEndpoint, $http, toastr, genericFactory) {
...
function confirmDelete() {
    ...
    var url = baseUrl + "/maintspares/delete/" + selectedSpare.maintspare_id;
			 ...
			 function loadSpares() {
			    ...
			    $http.get(url)
			        .then(function(response) {
			            ...
			            console.log("Fetched maintspares:", vm.spares);
			        })
			        .catch(function(error) {
			            console.error("Error fetching maintspares:", error);
			        });
			}

        function ok(spare) {
            var url = baseUrl + "/maintspares/create";
            var msg = "";
            
            // Check if all fields are filled
            if (!spare.spare_name || !spare.supplier_name || !spare.spare_type) {
