...
public class MaintSpareRepoCustomImpl implements MaintSpareRepoCustom {
	@PersistenceContext
	EntityManager entityManager;
	
	
	@Override
	public List<MaintSpare> getMaintSpareByLimit(int pageNo, int perPage) {
		...
		try {
			...
			result = (long) entityManager
					.createQuery(
							"SELECT count(*) FROM MaintSpare a ")
					.getSingleResult();
			q = entityManager.createQuery(
					"select a from  MaintSpare a ",
					MaintSpare.class);
			...
			List<MaintSpare> list = q.getResultList();
			return list;
	...
	@Override
	public List<MaintSpare> getMaintSpareByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from MaintSpare a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, MaintSpare.class);
	...
	@Override
	public int getMaintSpareCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
