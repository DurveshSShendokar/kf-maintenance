...
public class MachineOperationRepoCustomImpl implements MachineOperationRepoCustom {
	@PersistenceContext
	EntityManager entityManager;
	
	
	@Override
	public List<MachienOperation> getMachienOperationByLimit(int pageNo, int perPage) {
		...
		try {
			...
			result = (long) entityManager
					.createQuery(
							"SELECT count(*) FROM MachienOperation a ")
					.getSingleResult();
			q = entityManager.createQuery(
					"select a from  MachienOperation a ",
					MachienOperation.class);
			...
			List<MachienOperation> list = q.getResultList();
			return list;
	...
	@Override
	public List<MachienOperation> getMachienOperationByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from MachienOperation a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, MachienOperation.class);
	...
	@Override
	public int getMachienOperationCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
