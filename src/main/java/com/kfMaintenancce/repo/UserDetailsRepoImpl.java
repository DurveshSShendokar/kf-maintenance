...
public class UserDetailsRepoImpl implements UserDetailsRepoCustom {
	@PersistenceContext
	EntityManager entityManager;
	
	
	@Override
	public List<UserDetails> getUserDetailsByLimit(int pageNo, int perPage) {
		...
		try {
			...
			result = (long) entityManager
					.createQuery(
							"SELECT count(*) FROM UserDetails a ")
					.getSingleResult();
			q = entityManager.createQuery(
					"select a from  UserDetails a ",
					UserDetails.class);
	...
	@Override
	public List<UserDetails> getUserDetailsByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from UserDetails a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, UserDetails.class);
	...
	@Override
	public int getUserDetailsCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
