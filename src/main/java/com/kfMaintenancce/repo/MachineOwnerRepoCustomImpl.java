...
public class MachineOwnerRepoCustomImpl implements MachineOwnerRepoCustom {
	@PersistenceContext
	EntityManager entityManager;
	
	
	@Override
	public List<MachineOwner> getMachineOwnerByLimit(int pageNo, int perPage) {
		...
		try {
			...
			result = (long) entityManager
					.createQuery(
							"SELECT count(*) FROM MachineOwner a ")
					.getSingleResult();
			q = entityManager.createQuery(
					"select a from  MachineOwner a ",
					MachineOwner.class);
	...
	@Override
	public List<MachineOwner> getMachineOwnerByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from MachineOwner a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, MachineOwner.class);
	...
	@Override
	public int getMachineOwnerCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
