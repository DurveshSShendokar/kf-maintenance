...
public class MaintRepoCustomImpl implements MaintRepoCustom {
	@PersistenceContext
	EntityManager entityManager;
	
	
	@Override
	public List<Maint> getMaintByLimit(int pageNo, int perPage) {
		...
		try {
			...
			result = (long) entityManager
					.createQuery(
							"SELECT count(*) FROM Maint a ")
					.getSingleResult();
			q = entityManager.createQuery(
					"select a from  Maint a ",
					Maint.class);
			...
			List<Maint> list = q.getResultList();
			return list;
	...
	@Override
	public List<Maint> getMaintByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from Maint a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, Maint.class);
	...
	@Override
	public int getMaintCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
