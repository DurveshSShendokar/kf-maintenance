...
public class MaintenanceCheckPointRepoCustomImpl implements MaintenanceCheckPointRepoCustom {
	@PersistenceContext
	EntityManager entityManager;
	
	
	@Override
	public List<MaintenenaceCheckPoint> getMaintenenaceCheckPointByLimit(int pageNo, int perPage) {
		...
		try {
			...
			result = (long) entityManager
					.createQuery(
							"SELECT count(*) FROM MaintenenaceCheckPoint a ")
					.getSingleResult();
			q = entityManager.createQuery(
					"select a from  MaintenenaceCheckPoint a ",
					MaintenenaceCheckPoint.class);
			...
			List<MaintenenaceCheckPoint> list = q.getResultList();
			return list;
	...
	@Override
	public List<MaintenenaceCheckPoint> getMaintenenaceCheckPointByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from MaintenenaceCheckPoint a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, MaintenenaceCheckPoint.class);
	...
	@Override
	public int getMaintenenaceCheckPointCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
