...
public class BreakdownRepoCustomImpl implements BreakdownRepoCustom {
	@PersistenceContext
	EntityManager entityManager;
	
	
	@Override
	public List<Breakdown> getBreakdownByLimit(int pageNo, int perPage) {
		...
		try {
			...
			result = (long) entityManager
					.createQuery(
							"SELECT count(*) FROM Breakdown a ")
					.getSingleResult();
			q = entityManager.createQuery(
					"select a from  Breakdown a ",
					Breakdown.class);
	...
	@Override
	public List<Breakdown> getBreakdownByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from Breakdown a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, Breakdown.class);
	...
	@Override
	public int getBreakdownCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
