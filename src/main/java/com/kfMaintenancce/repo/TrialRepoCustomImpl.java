...
public class TrialRepoCustomImpl implements TrialRepoCustom {
	@PersistenceContext
	EntityManager entityManager;
	
	
	@Override
	public List<Trial> getTrialByLimit(int pageNo, int perPage) {
		...
		try {
			...
			result = (long) entityManager
					.createQuery(
							"SELECT count(*) FROM Trial a ")
					.getSingleResult();
			q = entityManager.createQuery(
					"select a from  Trial a ",
					Trial.class);
			...
			List<Trial> list = q.getResultList();
			return list;
	...
	@Override
	public List<Trial> getTrialByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from Trial a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, Trial.class);
	...
	@Override
	public int getTrialCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
