...
public class AssetAllocationHistoryRepoCustomImpl implements AssetAllocationHistoryRepoCustom {
	@PersistenceContext
	EntityManager entityManager;
	
	
	@Override
	public List<AssetAllocationHistory> getAssetAllocationHistoryByLimit(int pageNo, int perPage) {
		...
		try {
			...
			result = (long) entityManager
					.createQuery(
							"SELECT count(*) FROM AssetAllocationHistory a ")
					.getSingleResult();
			q = entityManager.createQuery(
					"select a from  AssetAllocationHistory a ",
					AssetAllocationHistory.class);
			...
			List<AssetAllocationHistory> list = q.getResultList();
			return list;
	...
	@Override
	public List<AssetAllocationHistory> getAssetAllocationHistoryByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from AssetAllocationHistory a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, AssetAllocationHistory.class);
	...
	@Override
	public int getAssetAllocationHistoryCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
