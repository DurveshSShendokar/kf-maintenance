...
public class MachineRepoCustomImpl implements MachineRepoCustom {
	@PersistenceContext
	EntityManager entityManager;
	
	
	@Override
	public List<Machine> getMachineByLimit(int pageNo, int perPage) {
	...
	@Override
	public List<Machine> getMachineByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from Machine a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, Machine.class);
	...
	@Override
	public int getMachineCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
