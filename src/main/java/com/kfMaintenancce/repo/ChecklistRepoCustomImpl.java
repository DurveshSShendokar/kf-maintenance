...
public class ChecklistRepoCustomImpl implements ChecklistRepoCustom {
	@PersistenceContext
	EntityManager entityManager;
	
	
	@Override
	public List<Checklist> getChecklistByLimit(int pageNo, int perPage) {
		...
		try {
			...
			result = (long) entityManager
					.createQuery(
							"SELECT count(*) FROM Checklist a ")
					.getSingleResult();
			q = entityManager.createQuery(
					"select a from  Checklist a ",
					Checklist.class);
			...
			List<Checklist> list = q.getResultList();
			return list;
	...
	@Override
	public List<Checklist> getChecklistByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from Checklist a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, Checklist.class);
	...
	@Override
	public int getChecklistCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
