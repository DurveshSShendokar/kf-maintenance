...
public class RoleRepoCustomImpl implements RoleRepoCustom {
	...
	@Override
	public List<Role> getRoleByLimit(int pageNo, int perPage) {
	...
	@Override
	public List<Role> getRoleByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
		...
		String queryStr = "from Role a where ";
		int i = 0;
		...
		q = entityManager.createQuery(queryStr, Role.class);
	...
	@Override
	public int getRoleCountByLimitAndGroupSearch(GroupSearchDTO groupSearchDTO) {
		// TODO Auto-generated method stub
